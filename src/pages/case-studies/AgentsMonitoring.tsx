...
const AgentsMonitoring = () => {
  ...
  const sections = [{
    ...
    content: <div className="space-y-4">
          ...
          <div className="w-full mt-8">
            <img src={designSystemChartsImage} alt="Design system charts showing single line chart, multi line chart, stats chart, and table chart components" className="w-full rounded-lg shadow-lg" />
          </div>
        </div>
  }, {
    title: "Results",
