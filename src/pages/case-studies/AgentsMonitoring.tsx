...
const AgentsMonitoring = () => {
  ...
  const sections = [{
    ...
    content: <div className="space-y-4">
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">UiPath had just launched AI Agents — autonomous systems that perceive, reason, act, and learn. To help enterprises, the team introduced a dedicated space to register, monitor and govern AI agents across their lifecycle. </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-6">
            <div className="p-4 bg-accent/50 rounded-lg">
              <p className="font-semibold text-primary text-base md:text-lg">Status:</p>
              <p className="text-muted-foreground text-base md:text-lg">Ongoing</p>
            </div>
            <div className="p-4 bg-accent/50 rounded-lg">
              <p className="font-semibold text-primary text-base md:text-lg">Timeline:</p>
              <p className="text-muted-foreground text-base md:text-lg">4 months</p>
            </div>
            <div className="p-4 bg-accent/50 rounded-lg">
              <p className="font-semibold text-primary text-base md:text-lg">Role:</p>
              <p className="text-muted-foreground text-base md:text-lg">Lead Designer</p>
            </div>
            <div className="p-4 bg-accent/50 rounded-lg">
              <p className="font-semibold text-primary text-base md:text-lg">Collaborators:</p>
              <p className="text-muted-foreground text-base md:text-lg">1 PM, 6 Engineers</p>
            </div>
          </div>
        </div>
  }, {
    ...
    content: <div className="space-y-4">
          ...
          <p className="font-bold text-foreground text-lg md:text-xl leading-relaxed">Key business objectives included:</p>
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            <div className="p-6 bg-accent/30 rounded-lg border border-border">
              <div className="text-3xl mb-3">🔗</div>
              <p className="font-semibold text-foreground mb-2 text-lg md:text-xl">Map Relationships</p>
              <p className="text-base md:text-lg text-muted-foreground">Connect design artifacts with deployed instances.</p>
            </div>
            <div className="p-6 bg-accent/30 rounded-lg border border-border">
              <div className="text-3xl mb-3">📊</div>
              <p className="font-semibold text-foreground mb-2 text-lg md:text-xl">Centralize Data</p>
              <p className="text-base md:text-lg text-muted-foreground">Support debugging and performance analysis in one place.</p>
            </div>
            <div className="p-6 bg-accent/30 rounded-lg border border-border">
              <div className="text-3xl mb-3">💡</div>
              <p className="font-semibold text-foreground mb-2 text-lg md:text-xl">Surface Insights</p>
              <p className="text-base md:text-lg text-muted-foreground">Identify trends, deviations, and optimization opportunities.</p>
            </div>
          </div>
        </div>
  }, {
    ...
    content: <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-5 gap-8 items-start mt-8">
            <div className="space-y-4 md:col-span-2">
              <p className="font-bold text-foreground text-lg md:text-xl leading-relaxed">Key insights:</p>
    ...
    content: <div className="space-y-4">
          ...
          <p className="font-bold text-foreground text-lg md:text-xl leading-relaxed">Key improvements:
      </p>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground text-base md:text-lg">
