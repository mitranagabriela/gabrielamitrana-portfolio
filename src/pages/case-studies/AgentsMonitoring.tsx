      ...
      content: (
        <div className="space-y-4">
          <p className="text-muted-foreground leading-relaxed">
            UiPath had just launched AI Agents — autonomous systems that perceive, reason, act, and learn. To help teams monitor them, an Instance Management space was introduced.
          </p>
          <p className="text-muted-foreground leading-relaxed">
